...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div>
                <a href="{{ route('admin.laporan.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="btn btn-success btn-sm">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>{{ $transaksis->sum('total_harga') }}</th>
                            <th>{{ $transaksis->sum('diskon') }}</th>
                            <th>{{ $transaksis->sum('total_akhir') }}</th>
                            <th colspan="2"></th>
                        </tr>
                    </tfoot>
                </table>
