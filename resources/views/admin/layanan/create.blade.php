                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_pelanggan" class="form-label font-weight-bold">
                                    <i class="fas fa-user mr-1 text-primary"></i> Nama Pelanggan
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('jenis_layanan') is-invalid @enderror" 
                                    ...
                                    <option value="Cuci Basah" {{ old('jenis_layanan') == 'Cuci Basah' ? 'selected' : '' }}>Cuci Basah</option>
                                    <option value="Cuci Kering" {{ old('jenis_layanan') == 'Cuci Kering' ? 'selected' : '' }}>Cuci Kering</option>
                                    <option value="Setrika" {{ old('jenis_layanan') == 'Setrika' ? 'selected' : '' }}>Setrika</option>
                                    <option value="Cuci + Setrika" {{ old('jenis_layanan') == 'Cuci + Setrika' ? 'selected' : '' }}>Cuci + Setrika</option>
                                    <option value="Dry Cleaning" {{ old('jenis_layanan') == 'Dry Cleaning' ? 'selected' : '' }}>Dry Cleaning</option>
                                </select>
                                @error('jenis_layanan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('harga_per_kilo') is-invalid @enderror" 
                                        id="harga_per_kilo" name="harga_per_kilo" value="{{ old('harga_per_kilo') }}" min="0" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('estimasi_waktu') is-invalid @enderror" 
                                        id="estimasi_waktu" name="estimasi_waktu" value="{{ old('estimasi_waktu') }}" min="1" required>
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h6 class="font-weight-bold">Contoh Pengisian:</h6>
